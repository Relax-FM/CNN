...
В этом файле происходит тест нейронной сети.
Чтобы запустить необходимо просто настроить config.yml под нужные параметры.
В нашем случае, в файл конфигураций в параметр test_model_path: нужно указать название сохраненной модели, которую хотите запустить
